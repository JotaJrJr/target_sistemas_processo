...
import 'package:target_sistemas_prova/common/features/login/view/login_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        Provider<CadastrarTextoViewModel>.value(
          value: CadastrarTextoViewModel(
            service: ServiceNotaImpl(),
          ),
        ),
      ],
      child: MaterialApp(
